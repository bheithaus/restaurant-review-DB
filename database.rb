...
def populate
  ...
  tenure_data = [
    ...
    {"chef_id"=>1, "restaurant_id"=>1, "start_date"=>"2004-03-10", "end_date"=>nil, "is_head_chef" => 0},
    {"chef_id"=>2, "restaurant_id"=>2, "start_date"=>"2012-09-05", "end_date"=>nil, "is_head_chef" => 1},
    {"chef_id"=>3, "restaurant_id"=>2, "start_date"=>"2012-07-29", "end_date"=>"2012-10-28", "is_head_chef" => 0},
    {"chef_id"=>4, "restaurant_id"=>3, "start_date"=>"2003-06-15", "end_date"=>nil, "is_head_chef" => 1},
    {"chef_id"=>5, "restaurant_id"=>1, "start_date"=>"2007-10-05", "end_date"=>nil, "is_head_chef" => 1},
    {"chef_id"=>6, "restaurant_id"=>6, "start_date"=>"2000-10-05", "end_date"=>nil, "is_head_chef" => 1}
  ]
  ...
  review_data = [
    {"critic_id"=>1,"restaurant_id"=>1,"review"=>nil,"score"=>5,"date"=>"2008-11-05"},
    {"critic_id"=>2,"restaurant_id"=>2,"review"=>nil,"score"=>3,"date"=>"2009-05-05"},
    {"critic_id"=>3,"restaurant_id"=>3,"review"=>nil,"score"=>5,"date"=>"2008-04-05"},
    {"critic_id"=>4,"restaurant_id"=>5,"review"=>nil,"score"=>3,"date"=>"2012-02-05"},
    {"critic_id"=>1,"restaurant_id"=>6,"review"=>nil,"score"=>4,"date"=>"2013-11-05"},
  ]
